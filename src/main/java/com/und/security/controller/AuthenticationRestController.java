...
public class AuthenticationRestController {
    ...
    public ResponseEntity<?> createAuthenticationToken(@RequestBody RestAuthenticationRequest authenticationRequest, Device device) throws AuthenticationException {
        ...
        UndUserDetails user = (UndUserDetails) userDetailsService.loadUserByUsername(authenticationRequest.getUsername());
    ...
    //, @RequestHeader(tokenHeader)
        ...
        UndUserDetails user = (UndUserDetails) userDetailsService.loadUserByUsername(username);
