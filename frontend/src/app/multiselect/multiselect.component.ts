...
export class MultiselectComponent implements OnInit, ControlValueAccessor, OnChanges, Validator {
...
@NgModule({
    ...
    declarations: [MultiselectComponent, ClickOutsideDirective, ScrollDirective, styleDirective, ListFilterPipe, Item, TemplateRenderer],
    exports: [MultiselectComponent, ClickOutsideDirective, ScrollDirective, styleDirective, ListFilterPipe, Item, TemplateRenderer]
})
