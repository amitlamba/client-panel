...
@Component({
  ...
  template: `
    ...
    <ul #list [hidden]="hidden" class="list-group">
        <li class="list-group-item list-group-item-action" *ngFor="let item of items; let i = index" [class.active]="activeIndex==i">
            <a (mousedown)="activeIndex=i;itemClick.emit();$event.preventDefault()">
